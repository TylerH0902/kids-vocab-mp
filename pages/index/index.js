...
const TERRAIN_PATCHES = [
  // ── Forest continent (caterpillar) — lush green ───────────────────
  { lat: -0.08, lon: -0.50, baseR: 0.54, fill: '#2E7D32', stroke: '#1B5E20', hi: '#66BB6A',
    pts: [[0.00,0.80],[0.30,1.14],[0.60,0.86],[0.90,1.18],[1.20,0.76],[1.55,1.12],[1.90,0.88],[2.25,1.16],[2.60,0.80],[2.95,1.10],[3.30,0.85],[3.65,1.14],[4.00,0.80],[4.35,1.10],[4.70,0.86],[5.05,1.12],[5.40,0.84],[5.75,0.88]] },
  { lat:  0.06, lon: -0.28, baseR: 0.32, fill: '#388E3C', stroke: '#1B5E20', hi: '#81C784',
    pts: [[0.0,0.86],[0.55,1.12],[1.1,0.84],[1.65,1.10],[2.2,0.82],[2.75,1.08],[3.3,0.86],[3.85,1.12],[4.4,0.84],[4.95,1.06],[5.5,0.88]] },
  // ── Mountain continent (wildthings) — rocky grey ──────────────────
  { lat:  0.22, lon:  0.60, baseR: 0.46, fill: '#546E7A', stroke: '#1A2C35', hi: '#90A4AE',
    pts: [[0.00,0.92],[0.28,0.58],[0.56,1.24],[0.84,0.62],[1.12,1.20],[1.40,0.60],[1.68,1.22],[1.96,0.64],[2.24,1.18],[2.52,0.68],[2.80,1.10],[3.08,0.58],[3.36,1.18],[3.64,0.64],[3.92,1.22],[4.20,0.60],[4.48,1.16],[4.76,0.66],[5.04,1.08],[5.32,0.72],[5.60,0.94]] },
  { lat:  0.10, lon:  0.44, baseR: 0.28, fill: '#455A64', stroke: '#1A2C35', hi: '#78909C',
    pts: [[0.0,0.88],[0.48,1.14],[0.96,0.70],[1.44,1.18],[1.92,0.74],[2.40,1.14],[2.88,0.70],[3.36,1.12],[3.84,0.76],[4.32,1.16],[4.80,0.72],[5.28,1.06]] },
  // Sandy highlands on the mountain continent
  { lat:  0.32, lon:  0.72, baseR: 0.22, fill: '#A1887F', stroke: '#4E342E', hi: '#BCAAA4',
    pts: [[0,0.90],[0.7,1.10],[1.4,0.82],[2.1,1.12],[2.8,0.88],[3.5,1.08],[4.2,0.84],[4.9,1.10],[5.6,0.90]] },
  // ── Dark cave continent (alice) — deep purple-black ───────────────
  { lat: -0.12, lon:  1.65, baseR: 0.38, fill: '#1A1A2E', stroke: '#0A0A14', hi: '#2D2D52',
    pts: [[0.0,0.88],[0.38,1.10],[0.76,0.76],[1.14,1.14],[1.52,0.82],[1.90,1.08],[2.28,0.78],[2.66,1.12],[3.04,0.86],[3.42,1.06],[3.80,0.80],[4.18,1.12],[4.56,0.84],[4.94,1.06],[5.32,0.88]] },
  { lat:  0.05, lon:  1.82, baseR: 0.24, fill: '#212136', stroke: '#0A0A14', hi: '#303056',
    pts: [[0.0,0.90],[0.65,1.10],[1.3,0.84],[1.95,1.08],[2.6,0.86],[3.25,1.12],[3.9,0.84],[4.55,1.06],[5.2,0.88]] },
  // ── Meadow continent (wonder) — bright lime green ─────────────────
  { lat:  0.26, lon:  2.75, baseR: 0.44, fill: '#558B2F', stroke: '#1B5E20', hi: '#9CCC65',
    pts: [[0.00,0.90],[0.38,1.12],[0.76,0.84],[1.14,1.10],[1.52,0.88],[1.90,1.14],[2.28,0.86],[2.66,1.08],[3.04,0.88],[3.42,1.12],[3.80,0.84],[4.18,1.06],[4.56,0.86],[4.94,1.10],[5.32,0.86]] },
  // ── Connecting land bridges ───────────────────────────────────────
  { lat:  0.08, lon:  0.08, baseR: 0.32, fill: '#4A7835', stroke: '#2E5820', hi: '#6A9850',
    pts: [[0,0.88],[0.65,1.12],[1.3,0.84],[1.95,1.08],[2.6,0.88],[3.25,1.10],[3.9,0.86],[4.55,1.06],[5.2,0.88]] },
  { lat:  0.05, lon:  1.12, baseR: 0.28, fill: '#4A7035', stroke: '#2E5020', hi: '#6A9045',
    pts: [[0,0.92],[0.75,1.10],[1.5,0.86],[2.25,1.08],[3.0,0.88],[3.75,1.10],[4.5,0.84],[5.25,1.02]] },
  { lat:  0.14, lon:  2.22, baseR: 0.26, fill: '#4A7835', stroke: '#2E5820', hi: '#6A9850',
    pts: [[0,0.86],[0.85,1.12],[1.7,0.84],[2.55,1.08],[3.4,0.88],[4.25,1.10],[5.1,0.86]] },
];
